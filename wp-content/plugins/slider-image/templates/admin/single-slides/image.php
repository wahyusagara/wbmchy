...
<div class="image-block">
	...
	<div class="edit-image">
		<a href="#" class="edit"><?php _e('Edit image', 'hugeit-slider'); ?></a>
	</div>
</div>
<div class="slider-option">
	<table>
		<tr>
			<td><input type="text" name="title_<?php echo $id; ?>" value="<?php echo $title; ?>" class="title title" placeholder="<?php _e('Title', 'hugeit-slider'); ?>" /></td>
		</tr>
		<tr>
			<td><textarea name="description_<?php echo $id; ?>" id="description" class="description" placeholder="<?php _e('Description', 'hugeit-slider'); ?>"><?php echo $description; ?></textarea></td>
		</tr>
		<tr>
			<td>
				<input
