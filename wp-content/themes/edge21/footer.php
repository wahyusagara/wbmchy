	...
	<div class="row">
		<div class="col-md-2">
			<div class="copyright" align="left">
				<a href="mailto:mail@mochy.id?Subject=Want To Ask " target="_top">
					<i class="fa fa-envelope-o" aria-hidden="true"></i> Mail@mochy.id
				</a>
		...
		<div class="col-md-8">
			<div class="copyright" align="left">
				Copyright © 2016 - MOCHY. Premium Handmade.
			</div>
		</div>
